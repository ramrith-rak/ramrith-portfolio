...
export const project01: CaseStudyProject = {
  ...
  description: "Full-stack HR management platform designed and built using AI-assisted development. 60+ screens across 7 functional modules.",
  type: "WEB APP",
  featured: true,
  ...
  sections: [
    ...
    },
    {
      ...
      heading: "Screenshots",
      images: [
        { src: "/projects/01/hero.png", alt: "HRM dashboard with role-adaptive views", caption: "Role-adaptive dashboard — employee view with attendance, requests, and events" },
        { src: "/projects/01/detail-1.png", alt: "HRM approvals and leave management screens", caption: "Leave requests and approvals hub — multi-step paper process replaced with a single-screen digital flow" },
      ],
    },
    {
      type: "learnings",
