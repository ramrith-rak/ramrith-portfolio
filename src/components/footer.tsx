      ...
      <div className="container mx-auto px-6 md:px-12">
        <div className="flex flex-col items-center text-center gap-12 mb-32">
          ...
          <a 
            ...
            className="inline-block bg-foreground text-background px-12 py-6 rounded-full text-xs font-bold uppercase tracking-[0.3em] transition-all hover:bg-accent hover:text-foreground hover:-translate-y-1 hover:shadow-xl hover:shadow-accent/20"
          >
            Get in Touch
          </a>
        </div>
